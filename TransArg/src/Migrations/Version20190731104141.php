 ...
 */
final class Version20190731104141 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE depot DROP partenaire_id, DROP compte_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE depot ADD partenaire_id INT DEFAULT NULL, ADD compte_id INT NOT NULL');
