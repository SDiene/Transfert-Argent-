...
return [
    ...
    '_apinew_compte' => [[], ['_controller' => 'App\\Controller\\CompteController::add'], [], [['text', '/api/compte']], [], []],
    'apidepot' => [[], ['_controller' => 'App\\Controller\\DepotController::index'], [], [['text', '/api/']], [], []],
    'apinew_depot' => [[], ['_controller' => 'App\\Controller\\DepotController::add'], [], [['text', '/api/depot']], [], []],
    'apipartenaire' => [[], ['_controller' => 'App\\Controller\\PartenaireController::index'], [], [['text', '/api/']], [], []],
    'apiadd_depot' => [[], ['_controller' => 'App\\Controller\\PartenaireController::add'], [], [['text', '/api/partenaire']], [], []],
    '_apitransaction' => [[], ['_controller' => 'App\\Controller\\TransactionController::index'], [], [['text', '/api/']], [], []],
    '_apinew_transaction' => [[], ['_controller' => 'App\\Controller\\TransactionController::add'], [], [['text', '/api/transaction']], [], []],
