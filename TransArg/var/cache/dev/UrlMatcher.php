...
return [
    ...
    [ // $dynamicRoutes
        ...
        222 => [[['_route' => '_apiadd_compte', '_controller' => 'App\\Controller\\CompteController::Ajout'], [], ['POST' => 0, 'GET' => 1], null, false, false, null]],
        241 => [[['_route' => '_apiadd_transaction', '_controller' => 'App\\Controller\\TransactionController::Ajout'], [], ['POST' => 0], null, false, false, null]],
        253 => [[['_route' => 'add_user', '_controller' => 'App\\Controller\\UserController::register'], [], ['POST' => 0], null, false, false, null]],
        262 => [
        ...
        298 => [[['_route' => 'api_entrypoint', '_controller' => 'api_platform.action.entrypoint', '_format' => '', '_api_respond' => 'true', 'index' => 'index'], ['index', '_format'], null, null, false, true, null]],
        329 => [[['_route' => 'api_doc', '_controller' => 'api_platform.action.documentation', '_format' => '', '_api_respond' => 'true'], ['_format'], null, null, false, true, null]],
        365 => [
