...
$this->services['nelmio_api_doc.generator.default'] = $instance = new \Nelmio\ApiDocBundle\ApiDocGenerator(new RewindableGenerator(function () {
    ...
    yield 2 => ($this->privates['nelmio_api_doc.describers.api_platform'] ?? $this->load('getNelmioApiDoc_Describers_ApiPlatformService.php'));
    yield 3 => ($this->privates['nelmio_api_doc.describers.swagger_php.default'] ?? $this->load('getNelmioApiDoc_Describers_SwaggerPhp_DefaultService.php'));
    yield 4 => ($this->privates['nelmio_api_doc.describers.route.default'] ?? $this->load('getNelmioApiDoc_Describers_Route_DefaultService.php'));
